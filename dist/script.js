...
/***/ "./src/js/lib/components/collapse.js":
/*!*******************************************!*\
  !*** ./src/js/lib/components/collapse.js ***!
  \*******************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.collapse = function (headActive = 'collapse-head-active', contentActive = 'collapse-content-active', padding = 40) {
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.collapse-head').collapse();
...
Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('.carousel').slider();
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.find = function (selector) {
  const objCopy = Object.assign({}, this); //let numberOfItems = 0;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.test = function () {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateOverTime = function (duration, cb, finalCb) {
  let timeStart;
...
$lib('#trigger').click(() => {
  $lib('#trigger').createModal({
    ...
    btns: {
      count: 2,
      settings: [['Close', ['btn-danger', 'mr-10'], true], ['Accept', ['btn-success'], false, () => {
        alert('Ok!');
      }]]
    }
  });
